 ...
 * Note this is Sub-Strategy_A which has doctor name set as "Ruchi Kashiwala" and this name is defined in super class
...
public class SubStrategy_A extends Doctor_Strategy {
	public void run() {
		System.out.println("This is Strategy A");
	
	name = "Ruchi Kashiwala";
